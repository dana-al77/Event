...
import '../pages/detail_hall_catgory.dart';


class EventCardByCategory extends StatefulWidget {
  EventCardByCategory({ required this.Event,super.key});
  EventByCategorymodel Event;

  @override
  State<EventCardByCategory> createState() => _EventCardByCategoryState();
}

class _EventCardByCategoryState extends State<EventCardByCategory> {
    ...
    return GestureDetector(
        onTap: () {
          Navigator.of(context).push(MaterialPageRoute(builder: (context) {
            return DetailsHallByCategory(Event: widget.Event,);
          }));
        },
