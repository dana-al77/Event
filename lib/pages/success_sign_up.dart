                  ...
                  child: Column(
                      ...
                      children: [
                       const Padding(
                          ...
                          child: CustomText('Verification Success',
                            style: TextStyle(fontSize: 24,color: Colors.purple,fontWeight: FontWeight.bold,fontFamily: 'Angkor'),),
                        ),
                        SizedBox(height: 30,),
                        Icon(
                        ...
                        child: Container(
                          ...
                          child: Center(child: CustomText('Go To Login',style: TextStyle(fontSize: 20,color:Colors.white ,fontFamily: 'Angkor'),))),)
                  ]),
                ),
              ),
            ),
